...
draw_healthbar(ui_placement_x, ui_placement_y + 45, ui_placement_x + 7, ui_placement_y + 56, current_buff_duration, $FF191919 & $FFFFFF, $FF0000FF & $FFFFFF, $FF00FF00 & $FFFFFF, 3, (($FF191919>>24) != 0), (($FF000000>>24) != 0));
...
draw_text_transformed(ui_placement_x  + 3, ui_placement_y + 58, string("S ") + "", 0.2, 0.2, 0);