...
/// @DnDArgument : "y1" "ui_placement_y + 45"
/// @DnDArgument : "x2" "ui_placement_x + 16"
/// @DnDArgument : "y2" "ui_placement_y + 56"
...
draw_healthbar(ui_placement_x + 9, ui_placement_y + 45, ui_placement_x + 16, ui_placement_y + 56, current_buff_duration, $FF191919 & $FFFFFF, $FF0000FF & $FFFFFF, $FF00FF00 & $FFFFFF, 3, (($FF191919>>24) != 0), (($FF000000>>24) != 0));
...
/// @DnDArgument : "y" "ui_placement_y + 58"
/// @DnDArgument : "xscale" "0.2"
/// @DnDArgument : "yscale" "0.2"
/// @DnDArgument : "caption" ""D ""
draw_text_transformed(ui_placement_x  + 11, ui_placement_y + 58, string("D ") + "", 0.2, 0.2, 0);