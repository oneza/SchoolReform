...
if place_meeting(x+move_x+wjump+hspeed, y-1, obj_floor){
	...
	if key_space{
		...
		//if (obj_player.image_xscale==1){key_right=1;}
		vspeed=-wjmpspeed;
		self.sprite_index=spr_player_jump_up;
		}
